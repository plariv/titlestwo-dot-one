...
$layout->blocks["top"][] = "details";$page_layouts["ttlaction_notes_view"] = $layout;
...
//	show one record only
	$keys=array();
	$strWhereClause="";
	$keys["idnotes"]=postvalue("editid1");
...
$arr = array();
$arr['fName'] = "idnotes";
$arr['viewFormat'] = ViewFormat("idnotes", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ttlactions_idttlactions";
$arr['viewFormat'] = ViewFormat("ttlactions_idttlactions", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "created";
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "note_content";
$arr['viewFormat'] = ViewFormat("note_content", $strTableName);
$fieldsArr[] = $arr;
...
//idnotes - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"idnotes", ""),"","",MODE_VIEW);
	if($mainTableOwnerID=="idnotes")
		$ownerIdValue=$value;
	$xt->assign("idnotes_value",$value);
	if(!$pageObject->isAppearOnTabs("idnotes"))
		$xt->assign("idnotes_fieldblock",true);
	else
		$xt->assign("idnotes_tabfieldblock",true);
////////////////////////////////////////////
//ttlactions_idttlactions - 
	
	$value="";
	$value = ProcessLargeText(GetData($data,"ttlactions_idttlactions", ""),"","",MODE_VIEW);
	if($mainTableOwnerID=="ttlactions_idttlactions")
		$ownerIdValue=$value;
	$xt->assign("ttlactions_idttlactions_value",$value);
...
//note_content - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"note_content", ""),"","",MODE_VIEW);
	if($mainTableOwnerID=="note_content")
		$ownerIdValue=$value;
	$xt->assign("note_content_value",$value);
...
/*$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("idnotes")."': '".(jsreplace(@$data["idnotes"]))."', ";
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='ttlaction_notes_edit.php?".$editlink."'\"");
