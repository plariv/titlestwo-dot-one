...
$layout = new TLayout("login","Extravaganza1Orange","MobileOrange");
...
//  username and password are stored in the database
	...
	$strSQL = "select * from ".AddTableWrappers("ttwousers")." where ".AddFieldWrappers($cUserNameField).
	...
	if($logged && $pageObject->isCaptchaOk)
	{
		...
		$_SESSION["GroupID"] = $data["groupmember"];
