...
$layout->blocks["top"][] = "pdf";$page_layouts["ttlaction_notes_print"] = $layout;
...
//	ttlactions_idttlactions - 
			...
			$record["ttlactions_idttlactions_value"]=$value;
...
//	note_content - 
			...
			$record["note_content_value"]=$value;
			if($col<$colsonpage)
...
$xt->assign("idnotes_fieldheadercolumn",true);
$xt->assign("idnotes_fieldheader",true);
$xt->assign("idnotes_fieldcolumn",true);
$xt->assign("idnotes_fieldfootercolumn",true);
$xt->assign("ttlactions_idttlactions_fieldheadercolumn",true);
$xt->assign("ttlactions_idttlactions_fieldheader",true);
$xt->assign("ttlactions_idttlactions_fieldcolumn",true);
$xt->assign("ttlactions_idttlactions_fieldfootercolumn",true);
...
$xt->assign("note_content_fieldheadercolumn",true);
$xt->assign("note_content_fieldheader",true);
$xt->assign("note_content_fieldcolumn",true);
$xt->assign("note_content_fieldfootercolumn",true);
