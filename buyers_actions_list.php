...
include("include/buyers_actions_variables.php");
...
$layout = new TLayout("list5","ExtravaganzaOrange","MobileOrange");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["buyers_actions_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "ttl_actions_idttl_actions";
			}
