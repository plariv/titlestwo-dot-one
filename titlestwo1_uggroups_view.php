...
$layout->blocks["top"][] = "details";$page_layouts["titlestwo1_uggroups_view"] = $layout;
...
$arr = array();
$arr['fName'] = "GroupID";
$arr['viewFormat'] = ViewFormat("GroupID", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Label";
$arr['viewFormat'] = ViewFormat("Label", $strTableName);
$fieldsArr[] = $arr;
...
//GroupID - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"GroupID", ""),"","",MODE_VIEW);
...
//Label - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"Label", ""),"","",MODE_VIEW);
	if($mainTableOwnerID=="Label")
		$ownerIdValue=$value;
	$xt->assign("Label_value",$value);
...
/*$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("GroupID")."': '".(jsreplace(@$data["GroupID"]))."', ";
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='titlestwo1_uggroups_edit.php?".$editlink."'\"");
