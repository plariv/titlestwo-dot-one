...
$gsqlWhereExpr="";
$gsqlTail="";
// $gstrSQL = "SELECT id,   username,   password,   active,   firstname,   lastname,   datecreated,   groupmember,   emailaddr  FROM ttwousers ";
$gstrSQL = gSQLWhere("");
...
$layout = new TLayout("ug_members","Extravaganza1Orange","MobileOrange");
