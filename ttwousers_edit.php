...
$layout->blocks["top"][] = "details";$page_layouts["ttwousers_edit"] = $layout;
...
$templatefile = "ttwousers_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: ttwousers_".$pageObject->getPageType().".php?".$keyGetQ);
...
/////////////////////////////////////////////////////////////
$query = $queryData_ttwousers->Copy();
...
if(!$data)
{
	...
	{
		header("Location: ttwousers_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='ttwousers_view.php?".$viewlink."'\"");
