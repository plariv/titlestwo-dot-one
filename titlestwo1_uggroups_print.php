...
$layout->blocks["top"][] = "pdf";$page_layouts["titlestwo1_uggroups_print"] = $layout;
...
//	GroupID - 
			$value="";
				$value = ProcessLargeText(GetData($data,"GroupID", ""),"field=GroupID".$keylink,"",MODE_PRINT);
			$record["GroupID_value"]=$value;

//	Label - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Label", ""),"field=Label".$keylink,"",MODE_PRINT);
...
$xt->assign("Label_fieldheadercolumn",true);
$xt->assign("Label_fieldheader",true);
$xt->assign("Label_fieldcolumn",true);
$xt->assign("Label_fieldfootercolumn",true);
