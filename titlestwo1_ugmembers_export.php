...
include("include/titlestwo1_ugmembers_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["titlestwo1_ugmembers_export"] = $layout;
...
$xt->display("titlestwo1_ugmembers_export.htm");

function ExportToExcel_old()
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=titlestwo1_ugmembers.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=titlestwo1_ugmembers.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=titlestwo1_ugmembers.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=titlestwo1_ugmembers.csv");
...
// write header
	...
	echo "</tr>";
			$totals = array();
		$totals["UserName"] = array("value" => 0, "numRows" => 0);
		$totalsFields[] = array('fName'=>"UserName", 'totalsType'=>'', 'viewFormat'=>"");
