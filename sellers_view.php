...
$layout->blocks["top"][] = "details";$page_layouts["sellers_view"] = $layout;
...
//	show one record only
	$keys=array();
	$strWhereClause="";
	$keys["idsellers"]=postvalue("editid1");
	$keys["ttl_actions_idttl_actions"]=postvalue("editid2");
	$keys["parties_idparties"]=postvalue("editid3");
...
/*$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("idsellers")."': '".(jsreplace(@$data["idsellers"]))."', ";
	$jsKeysObj .= "'".jsreplace("ttl_actions_idttl_actions")."': '".(jsreplace(@$data["ttl_actions_idttl_actions"]))."', ";
	$jsKeysObj .= "'".jsreplace("parties_idparties")."': '".(jsreplace(@$data["parties_idparties"]))."', ";
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='sellers_edit.php?".$editlink."'\"");
