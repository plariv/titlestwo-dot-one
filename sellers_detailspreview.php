...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["sellers_detailspreview"] = $layout;
...
if($mastertable == "parties")
{
	$where = "";
		$where.= GetFullFieldName("parties_idparties")."=".make_db_value("parties_idparties",$_SESSION[$strTableName."_masterkey1"]);
}
...
$xt->display("sellers_detailspreview.htm");
