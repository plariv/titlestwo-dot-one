...
$layout->blocks["top"][] = "details";$page_layouts["titlestwo1_uggroups_edit"] = $layout;
...
$templatefile = "titlestwo1_uggroups_edit.htm";
...
$skeys = "";
$savedKeys = array();
$keys["GroupID"]=urldecode(postvalue("editid1"));
$savedKeys["GroupID"]=urldecode(postvalue("editid1"));
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// key get query
	$keyGetQ = "";
		$keyGetQ.="editid1=".rawurldecode($keys["GroupID"])."&";
	// cut last &
	$keyGetQ = substr($keyGetQ, 0, strlen($keyGetQ)-1);	
	// redirect
	header("Location: titlestwo1_uggroups_".$pageObject->getPageType().".php?".$keyGetQ);
...
/////////////////////////////////////////////////////////////
$query = $queryData_titlestwo1_uggroups->Copy();
...
if(!$data)
{
	...
	{
		header("Location: titlestwo1_uggroups_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
if($inlineedit != EDIT_INLINE)
{
	...
	$xt->assign("show_key1", htmlspecialchars(GetData($data,"GroupID", "")));
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='titlestwo1_uggroups_view.php?".$viewlink."'\"");
