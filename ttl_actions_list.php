...
include("include/brokers_settings.php");
include("include/buyers_settings.php");
include("include/sellers_settings.php");
include("include/ttl_recordings_settings.php");
include("include/ttlaction_notes_settings.php");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["ttl_actions_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "ttlnumb";
					}
...
$layout->skins["mastergrid"] = "grid";
$layout->blocks["bare"][] = "mastergrid";$page_layouts["sellersactions_masterlist"] = $layout;

$layout = GetPageLayout("sellersactions", 'masterlist');
if($layout)
{
	$rtl = $xt->getReadingOrder() == 'RTL' ? 'RTL' : '';
	$xt->cssFiles[] = array("stylepath" => "styles/".$layout->style.'/style'.$rtl
