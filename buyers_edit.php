...
include("include/buyers_variables.php");
...
$layout->blocks["top"][] = "details";$page_layouts["buyers_edit"] = $layout;
...
$skeys = "";
$savedKeys = array();
$keys["idbuyers"]=urldecode(postvalue("editid1"));
$savedKeys["idbuyers"]=urldecode(postvalue("editid1"));
...
if(!$data)
{
	...
	{
		header("Location: buyers_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
if($inlineedit != EDIT_INLINE)
{
	...
	$xt->assign("show_key1", htmlspecialchars(GetData($data,"idbuyers", "")));
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='buyers_view.php?".$viewlink."'\"");
